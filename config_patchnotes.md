...
## Version 2.8.1
- update *crosshair_CS2* to version *2.2.0*
  - Valve changed crosshair commands, so recreated the old crosshair with the new commands
  - outdated commands still kept (for now)